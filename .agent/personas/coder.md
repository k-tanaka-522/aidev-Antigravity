...
- インフラ設計書: docs/04_インフラ設計/（ポート番号、環境変数の確認用）
- 実装方針: docs/03_アプリケーション設計/01_基本設計/06_実装方針.md
- 実装対象: [具体的な機能名]
- 技術標準: .agent/standards/tech/41_app/languages/typescript.md
- API仕様: [該当部分]
...
1. **技術標準（規約）との整合性**
   - 使用言語の技術標準（`.agent/standards/tech/41_app/languages/`）を再確認
   - コーディング規約に準拠しているか
   - ディレクトリ構成が標準に従っているか
...
**詳細**: `.agent/standards/tech/41_app/languages/` の各言語標準を参照
...
- [ ] **技術標準を確認したか？**
  - 使用する言語の技術標準（`.agent/standards/tech/41_app/languages/`）を確認
  - 使用するフレームワークの技術標準（`.agent/standards/tech/41_app/frameworks/`）を確認
  - セキュリティ標準（`.agent/standards/tech/49_common/security.md`）を確認
