...
- 技術標準: .agent/standards/tech/42_infra/iac/cloudformation.md
...
**詳細なサンプルコード**: `.agent/standards/tech/42_infra/iac/` を参照
...
1. **技術標準を読み込む**
   - CloudFormation: `.agent/standards/tech/42_infra/iac/cloudformation.md`
   - Terraform: `.agent/standards/tech/42_infra/iac/terraform.md`
...
- `.agent/standards/tech/42_infra/iac/cloudformation.md` - CloudFormation 規約
- `.agent/standards/tech/42_infra/iac/terraform.md` - Terraform 規約
- `.agent/standards/tech/49_common/security.md` - セキュリティ基準
...
**レビュー時の参照ドキュメント**:
- 基本設計書（13ファイル）
- 技術標準（`.agent/standards/tech/42_infra/iac/cloudformation.md`, `49_common/security.md`）
